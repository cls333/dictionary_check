...
def running(input_file, func_list=None):
    ...
    if sheet:
        ...
        output_info = 'Exception: 表级信息表不存在, 表级信息检核无法进行...'
        # time.sleep(10)
        yield output_info
        # print(output_info)
    ...
    if sheet:
        ...
        output_info = 'Exception: 字段级信息表不存在, 字段级信息检核无法进行...'
        # time.sleep(10)
        yield output_info
        # print(output_info)
    ...
    if sheet:
        ...
        output_info = 'Exception: 代码级信息表不存在, 代码级信息检核无法进行...'
        # time.sleep(10)
        yield output_info
        # print(output_info)
...
#     main(input_figet_datale='NDS1560.xlsx')
